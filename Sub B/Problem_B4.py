...
#
# Desired accuracy and validation_accuracy > 91%(okkkk buat callbacknya)
# ===================================================================================================
...
def solution_B4():
    ...
    # Make sure you used all of these parameters or you can not pass this test(okkk)
    vocab_size = 1000
    embedding_dim = 16
    max_length = 120
    trunc_type = 'post'
    ...
    train_labels_final = np.array(label_tokenizer.texts_to_sequences(y_train))
    validation_labels_final = np.array(label_tokenizer.texts_to_sequences(y_test))
    ...
    model.fit(train_pad, 
        train_labels_final, 
        epochs=500, 
        validation_data=(validation_pad, validation_labels_final),
        callbacks=[Callback()]    
    )
