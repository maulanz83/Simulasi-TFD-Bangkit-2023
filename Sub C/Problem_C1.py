...
#
# The test infrastructure expects a trained model that accepts(model yaa)
# an input shape of [1]
...
#
# Desired loss (MSE) < 1e-4 (epoch 1000 ae)->berti pake matriks mse buat ngitung loss
# =============================================================================
#ardan maulana nafi'a
#bagian inport library
import numpy as np
